...
DEFAULT_TICKERS= ['Brown_TOTAL', 'Brown_adventure', 'Brown_belles_lettres',
                  'Brown_editorial', 'Brown_fiction', 'Brown_government', 'Brown_hobbies',
		  'Brown_humor', 'Brown_learned', 'Brown_lore', 'Brown_mystery',
		  'Brown_news', 'Brown_religion', 'Brown_reviews', 'Brown_romance',
		  'Brown_science_fiction', 'FROWN_TOTAL', 'Frown_TOTAL',
		  'aesop-aesops_fables',
		  'alexander_hamilton_john_jay_and_james_madison-federalist_papers',
		  'anonymous-the_book_of_mormon',
		  'arthur_conan_doyle-the_return_of_sherlock_holmes', 'austen-emma',
		  'austen-persuasion', 'austen-sense', 'bible-kjv', 'blake-poems',
		  'bryant-stories', 'burgess-busterbrown', 'carroll-alice',
		  'charles_dickens-a_christmas_carol_a_ghost_story_of_christmas',
		  'chesterton-ball', 'chesterton-brown', 'chesterton-thursday', 'edgeworth-parents',
		  'h_g_wells-the_war_of_the_worlds', 'harriet_beecher_stowe-uncle_toms_cabin',
		  'hemingway-farewell', 'henry_james-the_american', 'henry_james-the_europeans',
		  'inaugural', 'inaugural_addresses', 'jack_london-the_call_of_the_wild',
		  'karl_marx_and_friedrich_engels-the_communist_manifesto',
		  'lewis_carroll-alices_adventures_in_wonderland', 'lewis_carroll-through_the_lookingglass',
		  'mark_twain-the_adventures_of_tom_sawyer_complete',
		  'mary_wollstonecraft_godwin_shelley-frankenstein', 'melville-moby_dick',
		  'milton-paradise', 'oscar_wilde-the_picture_of_dorian_gray', 
		  'plato-platos_republic', 'shakespeare-caesar', 'shakespeare-hamlet', 
		  'shakespeare-macbeth', 'sophocles-the_oedipus_trilogy', 'thomas_hardy-return_of_the_native', 'twain-huckleberry', 
		  'upton_sinclair-the_jungle', 'whitman-leaves', 'User_input']
