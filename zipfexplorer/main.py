...
def update(selected=None):
    ...
    #left_lin.title.text = '%s, Gini = %s' % (t1, round(gini(np.array(load_ticker(t1)[~load_ticker(t1)["word"].isin(ss[0:int(stopwords_1.value)])]["freq"].astype(float))),3))
    left_lin.title.text = '%s, TTR = %s' % (t1, round(len(load_ticker(t1)[~load_ticker(t1)["word"].isin(ss[0:int(stopwords_1.value)])]["freq"].astype(float)))/load_ticker(t1)[~load_ticker(t1)["word"].isin(ss[0:int(stopwords_1.value)])]["freq"].astype(float)).sum(),3)) + ', Gini = %s' % round(gini(load_ticker(t1)[~load_ticker(t1)["word"].isin(ss[0:int(stopwords_1.value)])]["freq"].astype(float))),3) + ', α = %s' % str(round(powerlaw.Fit(load_ticker(t1)[~load_ticker(t1)["word"].isin(ss[0:int(stopwords_1.value)])]["freq"].astype(float))).alpha,3)) + ', Η = %s' % str(round(ent(load_ticker(t1)[~load_ticker(t1)["word"].isin(ss[0:int(stopwords_1.value)])]["freq"].astype(float))),3))
    right_lin.title.text = '%s, Gini = %s' % (t2, round(gini(np.array(load_ticker(t2)[~load_ticker(t2)["word"].isin(ss[0:int(stopwords_1.value)])]["freq"].astype(float))),3))
    left_log.title.text = '%s, Gini = %s' % (t1, round(gini(np.array(load_ticker(t1)[~load_ticker(t1)["word"].isin(ss[0:int(stopwords_1.value)])]["freq"].astype(float))),3))
    right_log.title.text = '%s, Gini = %s' % (t2, round(gini(np.array(load_ticker(t2)[~load_ticker(t2)["word"].isin(ss[0:int(stopwords_1.value)])]["freq"].astype(float))),3))
